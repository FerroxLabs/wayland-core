...
criteria:
  ...
  - id: c3
    ...
    state: met
    evidence: "file:.github/workflows/ci.yml:3307:the job sits QUEUED and GitHub only cancels it after 24h"
    owner: core

...
criteria:
  - id: c1
    ...
    state: met
    evidence: "file:.github/workflows/ci.yml:3187:# not-aggregated: build-darwin-selfhosted"
    owner: core
  ...
  - id: c3
    ...
    state: met
    evidence: "file:.github/workflows/ci.yml:3197:the job sits QUEUED and GitHub only cancels it after 24h"
    owner: core

...
| GREEN — hosted second supplier | [33352985296](https://github.com/FerroxLabs/wayland-core/actions/runs/33352985296) | `windows-latest` (hosted) | **PASS** (5.775s / 2.055s) |
| RED — hosted second supplier | [33353374757](https://github.com/FerroxLabs/wayland-core/actions/runs/33353374757) | `windows-latest` (hosted) | **FAIL** |
...
The flip reproduces on **four Windows hosts across two runner fleets** — both self-hosted boxes and both
GitHub-hosted `windows-latest` runners — and on every one of them the red arm's failure set is the green arm's
failure set *plus exactly these two tests*. Nothing else moves.

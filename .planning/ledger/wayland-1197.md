...
criteria:
  ...
  - id: c3
    ...
    state: met
    evidence: "test:crates/wcore-agent/src/engine.rs::stream_error_exhausts_retries_then_fails_the_turn"
    owner: core
...
**Where.** scripts/check-test-env-globals.py (classifier in `scan()`, ~line 318; `self_test()` at line 437) and the ci.yml:1396-1425 comment block that describes it

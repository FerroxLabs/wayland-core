...
status: open
last_verified_commit: d555a28b3
criteria:
  - id: c1
  ...
  - id: c3
    ...
    state: not-met
    owner: core
    note: "The execution record notes a user latency tradeoff accepted separately. A disposition is not a measured pass, and it belongs where the failure is carried."
  - id: c4

...
criteria:
  ...
  - id: c2
    ...
    state: not-met
    owner: core
    note: "FILED 2026-08-30. Nothing has been done. The direct paths already do this through `unsaved_work::refusal_message` (wayland#1239); write.rs:219 and edit.rs:318 reconstruct a `why` from the re-observed state instead and always take the `changed_under_write` wording, which ends 'Nothing was changed.'"
  - id: c3

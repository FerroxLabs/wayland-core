...
criteria:
  - id: c1
    ...
    state: met
    evidence: "file:.github/workflows/ci.yml:2102:Executed $total tests, expected at least $MIN. A suite that exits 0 having run nothing"
    owner: core
  ...
  - id: c2
    ...
    state: met
    evidence: "file:.github/workflows/ci.yml:2177:done < <(python3 scripts/check-test-env-globals.py --shared-process-targets)"

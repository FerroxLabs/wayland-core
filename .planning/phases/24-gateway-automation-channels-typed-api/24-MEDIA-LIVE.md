...
fence-exposure: "3 files, ZERO Rust source. Added: `scripts/f24-media-live.mjs`, `scripts/f24-secret-sweep.sh`, and `.planning/phases/24-…/24-MEDIA-LIVE*`. No crate was modified, `crates/wcore-cli/src/{lib,main}.rs` untouched, no shared script edited (`scripts/f24-inbound.mjs` and `scripts/f24-tg-fixture.mjs` deliberately not touched)."

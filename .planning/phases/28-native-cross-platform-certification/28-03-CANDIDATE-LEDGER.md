...
| Field | Value |
|---|---|
| commit | `e4a3f5fc0f92a7b0126f594146c4b71182e9e378` |
| tree | `6a494c995358d76f0bb296abf3ea8a086b24c28b` |
| provisional | no |
| KR-05 wedge repair (`455dd836`) present | unknown |
...
| Field | Value |
|---|---|
| sha256 | `ab8cf3d34457b5897b94f8313a96f6dce04a95eb8f0d3bc3343fcba9bdb2991d` |
| path | `/root/wayland-p28-03-candidate` |
...
|---|---|---|---|---|
| `x86_64-unknown-linux-gnu` | linux | `wayland-core-x86_64-unknown-linux-gnu` | **bound** | `ab8cf3d34457b5897b94f8313a96f6dce04a95eb8f0d3bc3343fcba9bdb2991d` |
| `aarch64-unknown-linux-gnu` | linux | `wayland-core-aarch64-unknown-linux-gnu` | **bound** | `b4a9a3d096e35067854b6c2ba181368b407075c09ba14930b276826304d6a272` |
| `x86_64-apple-darwin` | macos | `wayland-core-x86_64-apple-darwin` | **bound** | `cb09067e9d35a2a9236cc6eb8702841c8c81e0c90298a8f43281fcbc03ad30e3` |
| `aarch64-apple-darwin` | macos | `wayland-core-aarch64-apple-darwin` | **bound** | `59f57fb3fa6a554645ace02ba2044439235cc9460c660a8392ac4df1e6fa7ce8` |
| `x86_64-pc-windows-msvc` | windows | `wayland-core-x86_64-pc-windows-msvc` | **bound** | `54b12e8e5576ee54e88a93975c360e6c624202059f449d80574b71adf00c631e` |
| `aarch64-pc-windows-msvc` | windows | `wayland-core-aarch64-pc-windows-msvc` | **bound** | `e716ee1127c67e6edca5d4d489f0ad2cef0a50b03a55c54e4b2767ce9915f78a` |

## 4. Surface inventory — read off the binary

**131 surfaces** discovered by interrogating the binary's own
command tree. No feature name was read out of a planning document into this list.

| Surface | Entrypoint | Attributed to |
|---|---|---|
| `cmd:acp` | `wayland-core acp` | 24 |
| `cmd:acp/request` | `wayland-core acp request` | 24 |
| `cmd:acp/serve` | `wayland-core acp serve` | 24 |
...
| `cmd:channel` | `wayland-core channel` | 24 |
| `cmd:channel/health` | `wayland-core channel health` | 24 |
| `cmd:channel/list` | `wayland-core channel list` | 24 |
| `cmd:channel/probe` | `wayland-core channel probe` | 24 |
| `cmd:channel/reload` | `wayland-core channel reload` | 24 |
...
| `cmd:goal` | `wayland-core goal` | — |
| `cmd:goal/effects` | `wayland-core goal effects` | — |
| `cmd:goal/exec-task` | `wayland-core goal exec-task` | — |
| `cmd:goal/open` | `wayland-core goal open` | — |
| `cmd:goal/run` | `wayland-core goal run` | — |
| `cmd:goal/status` | `wayland-core goal status` | — |
| `cmd:goal/task` | `wayland-core goal task` | — |
...
| `cmd:sandbox` | `wayland-core sandbox` | — |
| `cmd:sandbox/exec` | `wayland-core sandbox exec` | — |
| `cmd:sandbox/status` | `wayland-core sandbox status` | — |
...
|---|---|---|---|
| 24 | 7 | `channel`, `cron` | `acp`, `gateway`, `pid`, `wcore-contract` |
...
|---|---|---|---|
| `F-28-01-R001` | present-but-unclaimed | MEDIUM | surface `wayland-core agent` is exposed by the candidate binary and appears NOWHERE in any phase 24-27 artifact |
| `F-28-01-R002` | present-but-unclaimed | MEDIUM | surface `wayland-core crucible` is exposed by the candidate binary and appears NOWHERE in any phase 24-27 artifact |
| `F-28-01-R003` | attribution-weak | LOW | surface `wayland-core fetch` is exposed by the candidate binary and is discussed by phase artifact(s) 24,26, but not in a form this resolver recognises as a claim |
| `F-28-01-R004` | present-but-unclaimed | MEDIUM | surface `wayland-core forge` is exposed by the candidate binary and appears NOWHERE in any phase 24-27 artifact |
| `F-28-01-R005` | attribution-weak | LOW | surface `wayland-core goal` is exposed by the candidate binary and is discussed by phase artifact(s) 24,26,27, but not in a form this resolver recognises as a claim |
...
| `F-28-01-R013` | attribution-weak | LOW | surface `wayland-core sandbox` is exposed by the candidate binary and is discussed by phase artifact(s) 25,27, but not in a form this resolver recognises as a claim |
| `F-28-01-R014` | present-but-unclaimed | MEDIUM | surface `wayland-core self-update` is exposed by the candidate binary and appears NOWHERE in any phase 24-27 artifact |
| `F-28-01-R015` | attribution-weak | LOW | surface `wayland-core session` is exposed by the candidate binary and is discussed by phase artifact(s) 24,27, but not in a form this resolver recognises as a claim |
| `F-28-01-R016` | attribution-weak | LOW | surface `wayland-core setup` is exposed by the candidate binary and is discussed by phase artifact(s) 24,26, but not in a form this resolver recognises as a claim |
| `F-28-01-R017` | present-but-unclaimed | MEDIUM | surface `wayland-core swarm` is exposed by the candidate binary and appears NOWHERE in any phase 24-27 artifact |
| `F-28-01-R018` | attribution-weak | LOW | surface `wayland-core workflow` is exposed by the candidate binary and is discussed by phase artifact(s) 24,26, but not in a form this resolver recognises as a claim |
...
| Role | Path | sha256 |
|---|---|---|
| surface_capture | `.planning/phases/28-native-cross-platform-certification/evidence/28-03/surface-capture.txt` | `43e6dbde22288ab0…` |
...
| phase_artifact_24 | `.planning/phases/24-gateway-automation-channels-typed-api/24-03-SUMMARY.md` | `1d81b94545370717…` |
| phase_artifact_24 | `.planning/phases/24-gateway-automation-channels-typed-api/24-04-SUMMARY.md` | `86594c9def9b32c2…` |
...
| phase_artifact_26 | `.planning/phases/26-migration-export-backup-restore/26-03-SUMMARY.md` | `3b6cc6330d6c148d…` |

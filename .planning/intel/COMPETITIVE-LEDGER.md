...
| PORT-* | SOURCE | **REACHED** | **Promoted.** Real-credential discovery against Sean's actual peer installs; backup/restore/rollback claimed with a real Windows product defect fixed. The entire import half is unbuilt. |

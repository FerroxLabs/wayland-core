...
mod windows_impl {
    ...
    use super::appcontainer_acl_lease::ExecutionIdentity;
    use super::{ProbeCache, NEGATIVE_PROBE_TTL};
    ...
    use windows_sys::Win32::Security::{
        AllocateAndInitializeSid, CreateRestrictedToken, FreeSid, GetLengthSid, GetSidSubAuthority,
        GetSidSubAuthorityCount, GetTokenInformation, SetTokenInformation, TokenIntegrityLevel,
        DISABLE_MAX_PRIVILEGE, SECURITY_ATTRIBUTES, SECURITY_CAPABILITIES, SID_AND_ATTRIBUTES,
        SID_IDENTIFIER_AUTHORITY, TOKEN_ADJUST_DEFAULT, TOKEN_ASSIGN_PRIMARY, TOKEN_DUPLICATE,
    ...
    use windows_sys::Win32::System::Threading::{
        ...
        UpdateProcThreadAttribute, WaitForSingleObject, BELOW_NORMAL_PRIORITY_CLASS,
    ...
    fn execute_blocking(
        ...
        let execution = (|| -> Result<SandboxOutput> {
            unsafe {
                ...
                let stderr_reader =
                    std::thread::spawn(move || drain_pipe(stderr_h as _, output_bytes));

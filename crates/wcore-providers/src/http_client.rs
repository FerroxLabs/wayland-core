...
///
/// What it buys: against a blackhole the 11-attempt budget spends 8m09s at
/// 30 s and 4m29s at 10 s.
///
/// Kept in step with [`wcore_egress::CONNECT_TIMEOUT`], which is the same
/// deadline for egress-mediated clients; `the_two_connect_deadlines_agree`
/// fails if they drift.
